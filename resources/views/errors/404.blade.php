        ...
        <div class="col-sm-offset-2 col-sm-8">
            <div class="panel panel-danger">
                <div class="panel-heading">
                        <p class="panel-title w3-center w3-xxlarge">Oops, Page non trouvée !</p>
                </div>
                <div class="w3-center w3-padding-16">
                    <img src="{{asset('storage/images/404-image.png')}}" alt="pageNotFound" style="width:100px; height:100px;">
                </div>
                <div class="panel-body"> 
                   <p class="w3-xlarge w3-center">Nous sommes désolés mais la page que vous désirez n'existe pas...</p>
                </div>
            </div>
        </div>
    </div>
