 <div class="w3-top" style="z-index: 1">            
    <!-- large screen navbar -->
    <nav class="navbar navbar-default w3-hide-small w3-hide-medium" style="padding: 0 50px 0 20px; height: 55px">

        <div class="container-fluid row">
            <!--sub menu trigger-->
            <div class="col-xs-1 col-sm-1 w3-center w3-hover-white" style="padding: 10px 0 0 0; margin: 5px 0 0 0">
                <a href="#" onclick="showPannel('sitesmenu'); w3.hide('#logout'); w3.hide('#appsmenu1'); w3.hide('#appsmenu2')"><span class="w3-hover-text-red fa fa-navicon w3-xlarge" style="color: #55ACEE"></span></a>  
            </div> 
            ...
            <div class="col-xs-5 col-sm-5" style="padding: 8px 0 0 5px;">                  
                <form class="form-group">
                    ...
                    <div id="livesearch" class="w3-bar w3-bar-block w3-white"></div>
                </form>          
            </div>

            <!-- app auth menu-->
            <div class="col-xs-4 col-sm-4 w3-bar" style="padding: 8px 0 3px 0">   
                @if (Auth::guest())
                    ...
                    <a  href="#" style="height: 45px" class="w3-large w3-right w3-bar-item w3-text-black" onclick="showPannel('appsmenu1'); w3.hide('#sitesmenu')">
                        <span class="w3-hover-text-red glyphicon glyphicon-th w3-xlarge" style="color: #55ACEE"></span>
                    </a>                                          
                    @else
                    <a href="#" class="w3-text-blue w3-right w3-bar-item"  onclick="showPannel('appsmenu2'); w3.hide('#appSidebar'); w3.hide('#appsmenu1') ">
                        <i class="w3-hover-text-red w3-xlarge fa fa-user-circle "></i>
                    </a>                   
                    <a href="#" class="w3-right w3-bar-item w3-text-blue" onclick="showPannel('appsmenu1'); w3.hide('#appsmenu2'); w3.hide('#sitesmenu'); w3.addStyle('#appsmenu1', 'right','100px' )">
                        <span class="w3-hover-text-red glyphicon glyphicon-th w3-xlarge" style="color: #55ACEE"></span>
                    </a>                                     
    ...
    <div id="appsmenu1" class="w3-large w3-bar-block w3-card-2 w3-white" style="display: none; position: absolute; right: 300px; top: 50px; z-index: 1">
      <a href="#" class="w3-large w3-hover-red w3-bar-item btn w3-text-black w3-border-bottom w3-leftbar w3-border-green" onclick="w3.hide('#appsmenu1');">laps-learning</a>                                     
      <a href="#" class="w3-large w3-hover-red w3-bar-item btn w3-text-black w3-border-bottom w3-leftbar w3-border-green" onclick="w3.hide('#appsmenu1');">laps-news</a>
      <a href="#" class="w3-large w3-hover-red w3-bar-item btn w3-text-black w3-leftbar w3-border-green w3-bottombar" onclick="w3.hide('#appsmenu1');">laps-market</a> 
    </div>
    
    <!--profile sub menu-->
    <div id="appsmenu2" class="w3-bar-block w3-card-4 w3-white" style="display: none; position: absolute; right: 5px; top: 50px; z-index: 1">
      <a href="#" class="w3-large w3-hover-red w3-bar-item btn w3-text-black w3-border-bottom" onclick="w3.hide('#appsmenu2'); ">{{Auth::user()['name']}}</a>                                          
      <a href="{{ route('logout') }}" class="w3-large w3-hover-red w3-bar-item btn w3-text-black" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">  se deconnecter </a>
